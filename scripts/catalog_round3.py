...
def appflowy():
    ...
    web=svc('web',image='appflowyinc/appflowy_web:latest',env={'APPFLOWY_BASE_URL':public('appflowy'),'APPFLOWY_GOTRUE_BASE_URL':public('appflowy')+'/gotrue','APPFLOWY_WS_BASE_URL':'wss://'+ref('appflowy','RAILWAY_PUBLIC_DOMAIN')+'/ws/v2','PORT':80})
